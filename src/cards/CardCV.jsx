...
const Card = () => {
  return (
    <div className="relative duration-500 [transform:rotate3d(20_,-10,_1,_60deg)] hover:-rotate-0 group border border-theme_dark_green border-4 overflow-hidden rounded-2xl h-52 w-72 bg-theme_light_green p-5 flex flex-col items-start gap-4">
      ...
      <a href="/Certificados/CV-Santiago-Mangas.pdf" download>
      <button className="text-theme_light_brown duration-300 hover:bg-theme_teal border hover:text-black bg-gray-50 font-semibold text-themebg-theme_light_green px-3 py-2 flex flex-row items-center gap-3">
        Descargar CV 
